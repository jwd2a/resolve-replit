...
export function NavigationMenu() {
  ...
  const childSupportRoute = { name: "Child Support Estimator", path: "/childsupport" };
  const judicialDashboardRoute = { name: "Judicial Dashboard", path: "/judicial-dashboard" };
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              <Link href={childSupportRoute.path}>
                <DropdownMenuItem className="cursor-pointer py-2">
                  <Calendar size={16} className="mr-2 text-[#6c54da]" />
                  <span>Child Support Estimator</span>
                  {isActive(childSupportRoute.path) && (
                    <span className="ml-auto h-2 w-2 rounded-full bg-[#2e1a87]" />
                  )}
                </DropdownMenuItem>
              </Link>
              
              <Link href={judicialDashboardRoute.path}>
                <DropdownMenuItem className="cursor-pointer py-2">
                  <Scale size={16} className="mr-2 text-[#6c54da]" />
                  <span>Judicial Dashboard</span>
                  {isActive(judicialDashboardRoute.path) && (
                    <span className="ml-auto h-2 w-2 rounded-full bg-[#2e1a87]" />
                  )}
                </DropdownMenuItem>
              </Link>
              ...
              <Link href="/parenting-plan2">
                <DropdownMenuItem className="cursor-pointer py-2">
                  <FileText size={16} className="mr-2 text-[#6c54da]" />
                  <span>Parenting Plan 2</span>
                  {isActive("/parenting-plan2") && (
                    <span className="ml-auto h-2 w-2 rounded-full bg-[#2e1a87]" />
                  )}
                </DropdownMenuItem>
              </Link>
