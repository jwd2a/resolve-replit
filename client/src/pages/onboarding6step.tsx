...
export default function Onboarding6Step() {
  const { user } = useAuth();
  ...
  const canProceedToNext = () => {
    switch (currentStep) {
      ...
      case 4: // Required Forms
        ...
        return true;
      case 5: // Parenting Preferences (now step 5)
        // This step is optional
        return true;
      case 6: // Co-Parent Status (now step 6)
  ...
  const getStepTitle = () => {
    switch (currentStep) {
      ...
      case 5: return "Parenting preferences"; // Now step 5
      case 6: return "Co-parent invitation status"; // Now step 6
      default: return "";
    }
  };
      ...
      <div className="max-w-3xl mx-auto pt-6 px-4">
        <Card className="border-gray-200 shadow-sm">
          ...
          <CardContent>
            ...
            {/* Step 5: Parenting Preferences (swapped with step 6) */}
            {currentStep === 5 && (
              <div className="space-y-6">
                <div className="bg-gray-50 p-5 rounded-lg">
            ...
            {/* Step 6: Co-Parent Status (swapped with step 5) */}
            {currentStep === 6 && (
              <div className="space-y-6">
