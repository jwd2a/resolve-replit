      ...
      <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            {/* Payment section with height aligned with the last checklist item */}
            <div className="bg-white rounded-lg border border-gray-200 p-5 shadow-sm flex flex-col h-[215px]">
              {paymentStatus ? (
                <>
                ...
                <>
                  ...
                  <div className="bg-amber-50 border border-amber-100 rounded-lg p-2.5 flex items-center gap-2 mb-2">
                  ...
                  <div className="bg-gray-100 rounded-lg p-2.5 flex items-center justify-between mb-2">
